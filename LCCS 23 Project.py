...
# Hypothesis number 1 - 100 points wins
...
def singleplayer2():
    ...
    while player_score < 100:
        ...
        if player_word == word1 and valid_word(player_word):
            word_score = calculate_score(word1)
            ...
            print("Invalid word. Please try again.")
            print("------------------------------------------------------------------------")
    print("Congratulations! You reached 100 points and won the game!")
...
# Hypothesis Number 2 - What if the computer was given a difficulty level
print("Hypothesis Number 2 - What if the computer was given a difficulty level?")
print("")
...
difficulty = input("Choose a computer difficulty! - Easy/Normal/Hard, {E/N/H}: ").upper()
print("------------------------------------------------------------------------")
...
def difficultyeasy():
    while True:
        try:
            print("")
            num5_plays = int(input("How many times do you want to play the game?: "))
            print("------------------------------------------------------------------------")
            break
        except ValueError:
            print("------------------------------------------------------------------------")
    ...
    for i in range(num5_plays):
        ...
        if computer_word == word2:
            computer_word_score = calculate_score(word2)
            total_computer_score += computer_word_score
            print("")
            print("Computer score for this word: ", computer_word_score)
            print("")
            print("Total computer score so far: ", total_computer_score)
            print("------------------------------------------------------------------------")
        else:
            print("")
            print("Invalid word. Computer score: 0")
            print("")
            print("Total computer score so far: ", total_computer_score)
            print("------------------------------------------------------------------------")
        
        word = random.choice(words) # Get a new word for the next round
    
    print("")
    print("The computer's final score is: ", total_computer_score)

def difficultynormal(): # gives computer 1/2 odds
    while True:
        try:
            print("")
            num6_plays = int(input("How many times do you want to play the game?: "))
            print("------------------------------------------------------------------------")
            break
        except ValueError:
            print("------------------------------------------------------------------------")
    ...
    for i in range(num6_plays):
        ...
        computer_word = random.choice(words2) # give computer less words 1/2 odds of scoring better
        print("The computer's word is:", computer_word)

        if computer_word == word:
            computer_word_score = calculate_score(word)
            total_computer_score += computer_word_score
            print("")
            print("Computer score for this word:", computer_word_score)
            print("")
        ...
        word = random.choice(words2) # Get a new word for the next round
...
def difficultyhard():   
    while True:
        try:
            print("")
            num7_plays = int(input("How many times do you want to play the game?: "))
            print("------------------------------------------------------------------------")
            break
        except ValueError:
            print("------------------------------------------------------------------------")
